...
plus and initial condition determined by $I(0)$ and $R(0)$ (the
initial population has to be $N$).
...
We can modify model 2 to keep track of the cumulative infections ($C$)
